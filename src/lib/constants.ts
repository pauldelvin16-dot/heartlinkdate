...
export const AGE_GROUPS = [
  ...
  { v: "mature", l: "50–64 Mature" },
  { v: "senior", l: "65+ Senior" },
];
export const CONDITIONS = [
  "diabetes","autism","adhd","deaf","blind","wheelchair-user","hiv-positive","cancer-survivor",
  "mental-health","chronic-illness","single-parent","widowed","divorced",
];
